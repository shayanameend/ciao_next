...
import { OsType, OtpType, Roles, TokenType } from "~/lib/types";
...
export type ForgetPasswordBodyType = zod.infer<typeof forgetPasswordBodySchema>;
export type ResetPasswordBodyType = zod.infer<typeof resetPasswordBodySchema>;
export type CreateProfileBodyType = zod.infer<typeof createProfileBodySchema>;
export type LoginUserBodyType = zod.infer<typeof loginUserBodySchema>;
export type ChangePasswordBodyType = zod.infer<typeof changePasswordBodySchema>;
